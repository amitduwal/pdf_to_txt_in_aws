...
def pdf_to_text(input_pdf_object, output_text_bucket, output_text_key):
    ...
    # PyPDF2's PdfReader expects a file-like object or a file path as input to read the PDF file. 
    # By using BytesIO, we create a file-like object from the binary data, making it compatible with PyPDF2's interface.
